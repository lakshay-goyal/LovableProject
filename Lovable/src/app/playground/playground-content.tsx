...
export default function PlaygroundContent() {
  ...
  const { sandboxUrl, isProjectCreating, isLLMGenerating, filesRefreshTrigger, isFilesLoading, setIsFilesLoading, handleProjectStart } = usePlayground();
  ...
  }, [isAuthenticated, filesRefreshTrigger, isFilesLoading, setIsFilesLoading]);
                ...
                <div className="flex flex-col h-full">
                  <div className="bg-green-50 border-b border-green-200 px-4 py-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <Link href={sandboxUrl} target="_blank" rel="noreferrer" className="text-xs text-green-700 underline break-all">
                        {sandboxUrl}
                      </Link>
